...
<div class="card">
      ...
      <div className="flex flex-wrap p-20 mt-10">
        {cardData.map((card, index) => (
          // <div key={index} className="w-full sm:w-1/3 md:w-1/2 pl-5">
          //   <div className="bg-slate-1000 rounded-lg shadow-md p-3">
          //     <div className="container mx-auto flex justify-between items-center">
          //           <div className="flex flex-shrink-0 items-center mt-4 mb-4">
          //           <h2 className="text-lg font-semibold" style={{color:"#005B41"}}>{card.title}</h2>
          //           </div>
          //           <div className="hidden sm:ml-6 sm:block mt-4 mb-4">
          //             <div className="flex  space-x-10">
          //             <button
          //                 type="submit"
          //                 className=" bg-green-400 px-4 text-xs font-bold leading-6 text-white shadow-sm hover:bg-blue-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-100" style={{backgroundColor:"#39739d",borderRadius:20}}>
          //                 Join
          //               </button>
